        ...
        <div className="relative">
          ...
          <div className="absolute inset-0 overflow-hidden">
            <motion.div
              ...
              className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[800px] h-[400px] bg-primary/20 rounded-full blur-[100px]"
            />
          </div>
            ...
            <div className="max-w-4xl mx-auto text-center">
              ...
              >
                <div className="space-y-6">
                  ...
                  >
                    <h2 className="text-2xl text-primary-light mb-4">Coming Soon</h2>
                    <p className="text-gray-300">
                      We're crafting our story. Stay tuned to learn more about our mission to transform education through interactive learning.
                    </p>
                  </motion.div>
